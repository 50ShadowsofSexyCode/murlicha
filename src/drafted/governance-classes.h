 ...
 *
 *   // network
 *   CMurlichaNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.murlicha.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CMurlichaNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CMurlichaNetwork(UniValue objIn)
    {
...
// // can be under: MurlichaNetwork
// //   -- signature requirements : Key1(User)
// class CMurlichaNetworkVariable : public CGovernanceObject
// {
// private:
