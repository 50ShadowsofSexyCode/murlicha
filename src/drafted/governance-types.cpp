...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "MurlichaNetwork") type = MurlichaNetwork;
    if(strType == "MurlichaNetworkVariable") type = MurlichaNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == MurlichaNetwork) s = "MurlichaNetwork";
    if(type == MurlichaNetworkVariable) s = "MurlichaNetworkVariable";
