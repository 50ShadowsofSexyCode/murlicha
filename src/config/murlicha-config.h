/* src/config/murlicha-config.h.  Generated from murlicha-config.h.in by configure.  */
/* src/config/murlicha-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef MURLICHA_CONFIG_H

#define MURLICHA_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/murlichacoin/murlicha/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Murlicha Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Murlicha Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "murlichacore"
