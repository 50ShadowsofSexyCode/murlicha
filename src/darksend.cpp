...
{
    if(fLiteMode) return; // ignore all Murlicha related functionality
...
/*
    ...
    allow endless transaction that would bloat Murlicha and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("murlicha-privatesend");
