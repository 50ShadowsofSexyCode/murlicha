    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Murlicha Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Murlicha address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and murlicha: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Murlicha Core"), this);
    aboutAction->setStatusTip(tr("Show information about Murlicha Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Murlicha Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Murlicha addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Murlicha addresses"));
    ...
    openAction->setStatusTip(tr("Open a murlicha: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Murlicha Core help message to get a list with possible Murlicha Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Murlicha Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Murlicha network", "", count));
}
...
{
    QString strTitle = tr("Murlicha Core"); // default title
