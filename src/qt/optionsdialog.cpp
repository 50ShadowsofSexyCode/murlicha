    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("MURK-light"), QVariant("light"));
    ui->theme->addItem(QString("MURK-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("MURK-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("MURK-traditional"), QVariant("trad"));
