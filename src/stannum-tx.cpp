...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Murlicha Core murlicha-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  murlicha-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded murlicha transaction") + "\n" +
              "  murlicha-tx [options] -create [commands]   " + _("Create hex-encoded murlicha transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded murlicha transaction
