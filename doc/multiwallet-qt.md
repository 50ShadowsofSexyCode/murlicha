...
Only requiring some minor changes is murlicha.cpp.
...
Changes to murlicha.cpp
----------------------
murlicha.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
