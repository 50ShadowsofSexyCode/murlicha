...
This document provides guidelines for internationalization of the Murlicha Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        ...
        <translation>
            <numerusform>%n active connection to Murlicha network</numerusform>
            <numerusform>%n active connections to Murlicha network</numerusform>
        </translation>
    </message>
