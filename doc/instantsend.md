...
This mechanism has been integrated into Bitcore-Node-Murlicha which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/murlichacoin/insight-api-murlicha#web-socket-api](https://github.com/murlichacoin/insight-api-murlicha#web-socket-api) 
* API: [https://github.com/murlichacoin/insight-api-murlicha#instantsend-transactions](https://github.com/murlichacoin/insight-api-murlicha#instantsend-transactions) 
...
By default, the Murlicha Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Murlicha Core daemon:
