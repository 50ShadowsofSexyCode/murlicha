...
Murlicha Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Murlicha Core, where everyone uses
...
pay attention to for reviewers of Murlicha Core code.

General Murlicha Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Murlicha Core uses tinyformat, which is type safe. Leave them out to avoid confusion
