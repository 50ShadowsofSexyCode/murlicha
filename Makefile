...
pkgdatadir = $(datadir)/murlichacore
pkgincludedir = $(includedir)/murlichacore
pkglibdir = $(libdir)/murlichacore
pkglibexecdir = $(libexecdir)/murlichacore
...
CONFIG_HEADER = $(top_builddir)/src/config/murlicha-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/murlicha-config.h.in \
...
ACLOCAL = ${SHELL} /home/devboon/Desktop/murlicha/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/devboon/Desktop/murlicha/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/devboon/Desktop/murlicha/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/devboon/Desktop/murlicha/build-aux/missing automake-1.15
AWK = mawk
BDB_CPPFLAGS = 
...
MAINT = 
MAKEINFO = ${SHELL} /home/devboon/Desktop/murlicha/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL = 
OTOOL64 = 
PACKAGE = murlichacore
PACKAGE_BUGREPORT = https://github.com/murlichacoin/murlicha/issues
PACKAGE_NAME = Murlicha Core
PACKAGE_STRING = Murlicha Core 1.0.0
PACKAGE_TARNAME = murlichacore
PACKAGE_URL = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /home/devboon/Desktop/murlicha
abs_srcdir = /home/devboon/Desktop/murlicha
abs_top_builddir = /home/devboon/Desktop/murlicha
abs_top_srcdir = /home/devboon/Desktop/murlicha
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/devboon/Desktop/murlicha/build-aux/install-sh
...
BITCOIND_BIN = $(top_builddir)/src/murlichad$(EXEEXT)
BITCOIN_QT_BIN = $(top_builddir)/src/qt/murlicha-qt$(EXEEXT)
BITCOIN_CLI_BIN = $(top_builddir)/src/murlicha-cli$(EXEEXT)
BITCOIN_WIN_INSTALLER = $(PACKAGE)-$(PACKAGE_VERSION)-win$(WINDOWS_BITS)-setup$(EXEEXT)
OSX_APP = Murlicha-Qt.app
OSX_DMG = Murlicha-Core.dmg
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_murlicha_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info rpc_test.info rpc_test_filtered.info \
  leveldb_baseline_filtered.info test_murlicha_coverage.info test_murlicha.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/Murlicha-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/murlicha-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/murlicha-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/murlicha-config.h
$(top_srcdir)/src/config/murlicha-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/murlicha-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/Murlicha-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Murlicha-Qt

$(OSX_DMG): $(APP_DIST_EXTRAS)
	$(GENISOIMAGE) -no-cache-inodes -D -l -probe -V "Murlicha-Core" -no-pad -r -dir-mode 0755 -apple -o $@ dist
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Murlicha-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_murlicha.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_murlicha -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_murlicha_filtered.info: test_murlicha.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_murlicha_filtered.info
#	$(MKDIR_P) qa/tmp
...
#rpc_test.info: test_murlicha_filtered.info
...
#test_murlicha_coverage.info: baseline_filtered_combined.info test_murlicha_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_murlicha_filtered.info -o $@

#total_coverage.info: baseline_filtered_combined.info test_murlicha_filtered.info block_test_filtered.info rpc_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_murlicha_filtered.info -a block_test_filtered.info -a rpc_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_murlicha.coverage/.dirstamp:  test_murlicha_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_murlicha.coverage/.dirstamp total.coverage/.dirstamp

# Murlicha: disable the test until upstream switches from convoluted comparison tool
...
clean-local:
	rm -rf coverage_percent.txt test_murlicha.coverage/ total.coverage/ qa/tmp/ cache/ $(OSX_APP)
